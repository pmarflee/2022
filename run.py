...
run(lambda path: day12.calculate(shared.read_file_lines(path), 2), 12, 2, 'data\\day12.txt')
...
run(lambda path: day14.calculate(shared.read_file_lines(path), 2), 14, 2, 'data\\day14.txt')
